...
verdict back to the receipt store, and on accept mints a delivery-ready public
issue. Durable by construction — no long-lived credential, no autonomous merge.
